#!/usr/bin/env python3
"""
Generate Report Script for SORAT Pipeline
...
<html>
<head>
    <title>SORAT - Cardiac Segmentation Comparison Report</title>
    <style>
        :root {{
            color-scheme: light;
        }}
...
<body>
    <div class="container">
        <h1>🫀 SORAT - Cardiac Segmentation Comparison Report</h1>
...
"""
    ...
    html += f"""
        ...
        <div class="footer">
            <p>Generated by SORAT (Segmentation Orchestration and Reproducible Analysis Toolkit)</p>
